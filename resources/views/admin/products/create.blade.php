...
<div class="row">
  <div class="col-md-4">
   ...
   <input type="text" name="original_price" class="form-method"/>
    </div>
  </div>
</div>
<div class="col-md-4">
   ...
   <input type="text" name="selling_price" class="form-method"/>
</div>
</div>
<div class="col-md-4">
    <div class="mb-3">
   <label>Quantity</label>
   <input type="number" name="quantity" class="form-method"/>
</div>
</div>
